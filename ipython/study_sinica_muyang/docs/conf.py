...
# -*- coding:utf-8 -*-
#
# CosmEL documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'cosmel', 'CosmEL: Cosmetic Entity Linking',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CosmEL', 'CosmEL: Cosmetic Entity Linking',
     author, 'CosmEL', 'One line description of project.',
     'Miscellaneous'),
]
