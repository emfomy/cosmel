...
- rule:
  [i] data/repo                             (repo_preprocess)
  [i] data/article/pruned_article_role      (article_preprocess)
  [i] data/mention/pruned_article_role      (mention_preprocess)
  [o] data/mention/pruned_article_role_pid

- html_postprocess:
  [i] data/html/html_article_notag          (html_preprocess)
  [i] data/article/pruned_article_role      (article_preprocess)
  [o] data/html/pruned_article_role_idx
...
- html_encode:
  ...
  [i] data/article/pruned_article_role      (article_preprocess)
  [i] data/mention/pruned_article_role      (mention_preprocess)
  [i] data/html/pruned_article_role_idx     (html_postprocess)
  [o] data/html/pruned_article_role

- xml_encode:
  [i] data/repo                             (repo_preprocess)
  [i] data/article/pruned_article_role      (article_preprocess)
  [i] data/mention/pruned_article_role      (mention_preprocess)
  [o] data/xml/pruned_article_ws_pid
